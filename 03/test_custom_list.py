...
class TestCustomList(unittest.TestCase):
    def test_sum_two_custom_lists(self):
        ...
        self.assertEqual(cl1 + cl2, sum_cl1_cl2)
        self.assertEqual(cl2 + cl1, sum_cl1_cl2)
    ...
    def test_sum_custom_list_and_list(self):
        ...
        self.assertEqual(clst + lst, sum_cl_lst)
    ...
    def test_sub_two_custom_lists(self):
        ...
        self.assertEqual(cl1 - cl2, sub_cl1_cl2)
        self.assertEqual(cl2 - cl1, sub_cl2_cl1)
    ...
    def test_sub_custom_list_and_list(self):
        ...
        self.assertEqual(clst - lst, sub_cl_lst)
        self.assertEqual(lst - clst, sub_lst_cl)
